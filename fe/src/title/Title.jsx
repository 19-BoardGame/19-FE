    ...
    <div>
      <div className="flex flex-col items-center w-80 h-screen bg-neutral-300">
        ...
        <div className="relative top-24">
          <div className="flex flex-col justify-center bg-gray-50 drop-shadow-default rounded-lg w-60 h-9 cursor-pointer">
            <p className="text-center text-green font-semibold">로그인</p>
          </div>
          <div className="flex flex-col justify-center bg-green drop-shadow-default rounded-lg w-60 h-9 mt-4 cursor-pointer">
